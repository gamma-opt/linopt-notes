...
\input{chapters/chapter_8/exercises/E71-ULSformulations}

\subsection*{Exercise 8.2: TSP formulation - MTZ}
\input{chapters/chapter_8/exercises/E72-TSPformulation}

\subsection*{Exercise 8.3: TSP implementation}
\input{chapters/chapter_8/exercises/E73-TSPMTZ}

\subsection*{Exercise 8.4: TSP formulation - tightening the MTZ formulation}
\input{chapters/chapter_8/exercises/E74-TSPvalidineq}

\subsection*{Exercise 8.5: Scheduling problem}
\input{chapters/chapter_8/exercises/E75-Wolsey1-10}

\subsection*{Exercise 8.6: Piecewise linear objective functions and logical constraints}
\input{chapters/chapter_8/exercises/E86-paintfactoryextended}
