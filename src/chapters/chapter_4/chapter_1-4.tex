...
\begin{figure}[h]
	\begin{tikzpicture}
		\node (figure) at (0,0) {\includegraphics{chapters/chapter_4/figures/Figure1.pdf}};
...
\begin{figure}[h]
	\begin{tikzpicture}
		\node (pic) at (0,0) {\includegraphics{chapters/chapter_4/figures/Figure2.pdf}}; 
...
%			\draw[help lines] (-2,-3) grid (2,3);
		\node (pic) at (0,0) {\includegraphics{chapters/chapter_4/figures/Figure3.pdf}}; 
		\node (z) at (-2.5, 2.6) {$z$};
		\node (F) at (-2, -0.1) {$F$};
		\node (G) at (-0.7, -0.5) {$G$};
        \node (H) at (-0.1, 0.1) {$H$};
...
\begin{figure}[h]
	\begin{tikzpicture}
%			\draw[help lines] (-2,-3) grid (2,3);
		\node (pic) at (0,0) {\includegraphics{chapters/chapter_4/figures/Figure4.pdf}}; 
		\node (1) at (1.8, 0.8) {$1$};
		\node (6) at (1.65, 1.8) {$6$}; 		   		
		\node (3) at (-1.3, 0.3) {$3$}; 		   		
		\node (2) at (1.1, -0.05) {$2$};
...
\input{chapters/chapter_4/exercises/E41-tfsimplex}

\subsection*{Exercise 4.2: The simplex method}
\input{chapters/chapter_4/exercises/E42-simplex}

\subsection*{Exercise 4.3: Solving a tableau}
\input{chapters/chapter_4/exercises/E43-tableau}

\subsection*{Exercise 4.4: Two-phase simplex method}
\input{chapters/chapter_4/exercises/E44-twophasesimplex}
