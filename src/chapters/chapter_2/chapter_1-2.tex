...
%	    \draw[help lines] (-2,-2) grid (2,3);
		\node (pic) at (0,0) {\includegraphics{chapters/chapter_2/figures/Figure1}};
...
%			\draw[help lines] (-4,-2) grid (4,2);
		\node (pic) at (0,0) {\includegraphics{chapters/chapter_2/figures/Figure2}};
...
\begin{figure}
	\begin{tikzpicture}
	    \node (pic) at (0,0) {\includegraphics{chapters/chapter_2/figures/Figure3}};
	    \node (x0) at (0,-0.4) {$x_0$};
...
\begin{figure}[h]
			\begin{tikzpicture}
		    \node (pic) at (0,0) {\includegraphics{chapters/chapter_2/figures/Figure4}};
		    \node (a) at (-4.5,0.2) {$a$};
...
\begin{figure}
	\begin{tikzpicture}
		\node (pic) at (0,0) {\includegraphics{chapters/chapter_2/figures/Figure5}};
		% Left pic line
...
\begin{figure}
	\begin{tikzpicture}
		\node (pic) at (0,0) {\includegraphics{chapters/chapter_2/figures/Figure6}};
...
%			\draw[help lines] (-5,-1) grid (5,1);
		\node (pic) at (0,0) {\includegraphics{chapters/chapter_2/figures/Figure7}};
	\end{tikzpicture}
    \vspace{-6pt}
...
\begin{figure}
	\begin{tikzpicture}
		\node (pic) at (0,0) {\includegraphics{chapters/chapter_2/figures/Figure8}};
		\node (Pl) at (-2.5, 0) {$P$};
		\node (Pr) at (3, 0) {$P$};
		\node (wl) at (-3, 0.9) {$w$};
		\node (xl) at (-2.3, -1.5) {$x$};
...
\begin{figure}[h]
	\begin{tikzpicture}
		\node (pic) at (0,0) {\includegraphics{chapters/chapter_2/figures/Figure9}};
		\node (x1) at (1.5, -2) {$x_1$};
...
\begin{figure}[h]
	\begin{tikzpicture}
		\node (pic) at (0,0) {\includegraphics{chapters/chapter_2/figures/Figure10}};
...
\input{chapters/chapter_2/exercises/E21-polyhedra}

\subsection*{Exercise 2.2: Convexity of polyhedral sets}
\input{chapters/chapter_2/exercises/E22-convexity}

\subsection*{Exercise 2.3: Inverses, linear independence, and solving $Ax = b$} 
\input{chapters/chapter_2/exercises/E23-inverses}

\subsection*{Exercise 2.4: Linear independence}
\input{chapters/chapter_2/exercises/E24-independence}

\subsection*{Exercise 2.5: Properties of active constraints}
\input{chapters/chapter_2/exercises/E25-actconst}

\subsection*{Exercise 2.6: Vertex, extreme points, and BFSs}
\input{chapters/chapter_2/exercises/E26-bfs}

\subsection*{Exercise 2.7: Binding constraints} 
\input{chapters/chapter_2/exercises/E27-binding}
